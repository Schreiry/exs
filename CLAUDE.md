# CLAUDE.md — Exsul (new AI business assistant core)
...
src-tauri/src/
  ...
  ai/                 # provider-agnostic AI Gateway
    ...
    openai.rs gemini.rs claude.rs mock.rs     # providers (mock = no-key dev/tests)
...
- **Claude** uses Anthropic Messages API, model `claude-opus-4-8` (no
